...
//		
//		for(int i =0; albumList.size(); i++) {
//			localUrl = albumList.get(i).getPhoto();
//			if(albumList.get(i).getPhoto()==null) {
//				localImage = new Image("C:\\Users\\kim byung gon\\eclipse-workspace\\MS_java_Project2\\src\\image\\image1.jpg",false);
//				albumList.get(i).setPhoto(localImage);
//			}else {
